...
class Posetrack2021(torch.utils.data.Dataset):
    """Dataset reader for Posetrack2021 as a multi person pose estimation dataset."""
    ...
    def group_annotations(self, file_raw_annotation):
        ...
        # change image_id to frame_id
        new_all_images = []
        for image in all_images:
            if 'image_id' in image:
                image["frame_id"] = image.pop("image_id")
            new_all_images.append(image)
